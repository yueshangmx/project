...
jQuery.extend(jQuery, {
  ...
  jqalert: function (text, title, fn) {
    var html =
      ...
      '    <span class="ui-icon ui-icon-alert" style="float: left; margin: 2px 7px 0 0;"></span>' + text +
      '  </p>' +
      '</div>';
    return $(html).dialog({
      //autoOpen: false,
  ...
  jqconfirm: function (text, title, fn1, fn2) {
    var html =
      ...
      '  <p class="ui-state-error-text">' +
      '    <span class="ui-icon ui-icon-alert" style="float: left; margin: 2px 7px 20px 0;"></span>' + text +
      '  </p>' +
      '</div>';
    return $(html).dialog({
      //autoOpen: false,
